...
class Config(object):
    API_ID = int(os.environ.get("APP_ID", "23997193"))
    API_HASH = os.environ.get("API_HASH", "6b57b098476b03727cdd48037477b63b")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5918515576:AAEF0691a07lriGgdGAatwDU2vCVscJiuY8")
